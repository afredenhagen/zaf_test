sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/mindsquare/gdmvt/receipt/ushio/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("com.mindsquare.gdmvt.receipt.ushio.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/mindsquare/gdmvt/receipt/ushio/localService/mockserver"], function (mockserver) {
