sap.ui.define([
	...
	"use strict";
	return BaseObject.extend("com.mindsquare.gdmvt.receipt.ushio.controller.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias com.mindsquare.gdmvt.receipt.ushio.controller.ListSelector
		 */
		...
		constructor: function () {
			...
			this.oWhenListLoadingIsDone = new Promise(function (fnResolve, fnReject) {
				...
				this._oWhenListHasBeenSet
					.then(function (oList) {
						debugger;
						if (oList.getBinding("items") !== undefined) {
		 ...
		 * @return {com.mindsquare.gdmvt.receipt.ushio.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
